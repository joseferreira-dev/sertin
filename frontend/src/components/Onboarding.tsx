...
export default function Onboarding({ onComplete }: Props) {
  ...
  return (
    <div
      ...
      style={{ background: 'radial-gradient(ellipse at 50% 0%, #0e1a2e 0%, #07090d 60%)' }}
    >
      {/* Brand */}
      <div className="flex items-center gap-2 mb-8">
        ...
        <span className="text-lg font-bold" style={{ letterSpacing: '-0.03em' }}>
          Sertin
        </span>
      </div>
          ...
          <div key={s} className="flex items-center">
            ...
            {i < steps.length - 1 && (
              <div
                ...
                style={{ background: i + 1 < step ? 'var(--primary)' : 'var(--border)' }}
              />
            )}
          </div>
        ))}
      ...
      >
        ...
        {step === 2 && (
          <>
            ...
            <p className="text-sm mb-5" style={{ color: 'var(--muted-foreground)' }}>
              Adicione as contas onde você movimenta dinheiro
            </p>
            <div className="flex flex-col gap-2 mb-4">
              {accounts.map((acc, i) => (
                ...
                >
                  ...
                  <span className="text-sm mono" style={{ color: 'var(--muted-foreground)' }}>
                    R$ {acc.balance || '0,00'}
                  </span>
                </div>
              ))}
            ...
            {showNewAccount ? (
              ...
              <button
                ...
                className="w-full py-2.5 rounded-lg text-sm flex items-center justify-center gap-2 transition-opacity hover:opacity-80"
        ...
        {step === 3 && (
          <>
            ...
            <p className="text-sm mb-5" style={{ color: 'var(--muted-foreground)' }}>
              Desmarque as categorias que não usa
            </p>
              ...
              {defaultCategories.map((cat) => (
                ...
                >
                  <div
                    ...
                    style={{
                      background: selectedCats.includes(cat) ? 'var(--primary)' : 'var(--border)',
                    }}
                  >
        ...
        {step === 4 && (
          <>
            ...
            <p className="text-sm mb-5" style={{ color: 'var(--muted-foreground)' }}>
              Revise suas configurações antes de começar
            </p>
            <div className="flex flex-col gap-3">
              {[
                ...
                { label: 'Contas criadas', value: `${accounts.length} conta(s)` },
                {
                  ...
                  value: `${selectedCats.length} de ${defaultCategories.length}`,
                },
              ].map(({ label, value }) => (
                <div
                  key={label}
